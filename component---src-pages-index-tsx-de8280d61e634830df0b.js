...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }()), __webpack_require__(366)(module)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	const react_1 = __webpack_require__(6);
	const transform = __webpack_require__(264);
	...
	class ComponentPage extends react_1.Component {
	    ...
	    render() {
	        ...
	        return React.createElement("div", null, React.createElement("h2", { id: metadata.displayName }, React.createElement("a", { href: `#${metadata.displayName}` }, metadata.displayName)), React.createElement("p", { dangerouslySetInnerHTML: { __html: extractMarkdown(metadata) } }), React.createElement("h3", null, React.createElement("div", null, "Props"), metadata.composes && React.createElement("small", { style: { fontStyle: 'italic', fontSize: '70%' } }, "Accepts all props from ", metadata.composes.map(p => `<${p.replace('./', '')}>`).join(', '), " unless otherwise noted.")), metadata.props.map(p => this.renderProp(p, metadata.displayName)));
	    }
	    renderType(prop) {
	        let type = prop.type || {};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	class Index extends react_1.Component {
	    ...
	    render() {
	        ...
	        return React.createElement("div", { className: "container", style: { marginTop: "2rem" } }, React.createElement("h1", null, "React Transition Replace"), React.createElement("section", null, React.createElement("h2", null, "Getting Started"), React.createElement("p", null), React.createElement("h3", { className: "h4" }, "Installation"), React.createElement("pre", null, React.createElement("code", null, `
	# npm
	npm install react-transition-replace --save
	# yarn
	yarn add react-transition-replace
	`)), React.createElement("h3", { className: "h4" }, "CDN / External"), React.createElement("p", null, "Since react-transition-group is fairly small, the overhead of including the library in your application is negligible. However, in situations where it may be useful to benefit from an external CDN when bundling, link to the following CDN: ", React.createElement("a", { href: "https://unpkg.com/react-transition-replace/dist/react-transition-replace.min.js" }, "https://unpkg.com/react-transition-group/dist/react-transition-replace.min.js"))), React.createElement("h2", null, "Components"), React.createElement(ComponentPage_1.default, { metadata: transitionReplace }), React.createElement(ComponentPage_1.default, { metadata: switchTransition }));
	    }
	}
	Index.propTypes = {
...
//# sourceMappingURL=component---src-pages-index-tsx-de8280d61e634830df0b.js.map